...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Enhanced primary color palette with better gradients
        'primary': {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
      ...
      backgroundImage: {
        ...
        'accessibility-hero': 'linear-gradient(135deg, #0ea5e9 0%, #0369a1 100%)',
        'tool-card': 'linear-gradient(145deg, #ffffff 0%, #f8fafc 100%)',
      },
      screens: {
        'xs': '475px',
      },
    ...
    function({ addUtilities, theme }) {
      const newUtilities = {
        '.focus-visible-ring': {
          '&:focus-visible': {
            outline: 'none',
            'box-shadow': `0 0 0 ${theme('ringWidth.DEFAULT')} ${theme('colors.primary.500')}`,
            'border-color': theme('colors.primary.500'),
          },
        },
        '.high-contrast-border': {
          '.high-contrast &': {
            'border-color': `${theme('colors.contrast.border')} !important`,
          },
        },
        '.interactive-hover': {
